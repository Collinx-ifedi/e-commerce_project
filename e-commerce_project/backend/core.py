...
_DEFAULT_FRONTEND_PATH = os.path.join(_PROJECT_ROOT, "frontend")
...
class Settings(BaseSettings):
    ...
    FRONTEND_DIR: str = Field(default=_DEFAULT_FRONTEND_PATH)
    STATIC_DIR: str = Field(default=_DEFAULT_FRONTEND_PATH)
