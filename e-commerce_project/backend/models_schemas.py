...
# Fixed: SQLAlchemy self-referential relationship & Pydantic V2 Migration
...
class Category(Base, TimestampMixin):
    ...
    # FIXED: Standard Adjacency List Pattern
    # Use remote_side=[id] to indicate the 'one' side of the relationship is the parent
...
class Product(Base, TimestampMixin, SoftDeleteMixin):
    ...
    def final_price(self) -> float:
        """Calculates price after discount. Used by Pydantic 'from_attributes'."""
...
class ProductSchema(ORMBase):
    ...
    # In V2 with from_attributes=True, Pydantic will call the .final_price() 
    # method on the ORM object automatically.
