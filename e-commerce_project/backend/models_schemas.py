...
# Updated for Multi-Product Cart Support & Digital Code Management
...
class Order(Base, TimestampMixin):
    ...
    payment_method = Column(SQLEnum(PaymentMethod), default=PaymentMethod.CRYPTO)
    
    # Payment Gateway Data
    payment_reference = Column(String(255), index=True) # BTCPay Invoice ID
...
class Transaction(Base, TimestampMixin):
    ...
    provider = Column(String(50), default="BTCPay")
